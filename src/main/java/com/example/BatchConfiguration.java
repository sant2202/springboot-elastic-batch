...
public class BatchConfiguration {
  ...
  @Bean
  public Step step2() {
    return stepBuilderFactory.get("step2").<Person, Person> chunk(10).reader(reader())
        .processor(processor()).writer(elasticWriter()).build();
  }

  private ItemWriter<? super Person> elasticWriter() {
